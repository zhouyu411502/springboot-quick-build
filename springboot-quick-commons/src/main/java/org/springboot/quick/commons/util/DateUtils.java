...
public class DateUtils {
	...
	public static java.util.Date stringToDate(String paramString1, String paramString2) throws Exception {
	...
	public static java.util.Date compactStringToDate(String paramString) throws Exception {
	...
	public static java.util.Date addDays(java.util.Date paramDate, int paramInt) throws Exception {
	...
	public static java.util.Date addDays(String paramString1, String paramString2, int paramInt) throws Exception {
		Calendar localCalendar = Calendar.getInstance();
	...
	public static java.sql.Date getSqlDate(java.util.Date paramDate) throws Exception {
	...
	public static java.util.Date parseDateTime(String paramString) throws Exception {
		if ((paramString == null) || (paramString.trim().equals("")))
			return null;
		SimpleDateFormat localSimpleDateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		localSimpleDateFormat.setLenient(false);
	...
	public static void main(String[] paramArrayOfString) {
		try {
			...
			System.out.println(sysDateToNum());
